/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ad3757f8e1e9924bf509276626a907a4)
// Runtime types generated with workerd@1.20260212.0 2025-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RaftNode" | "ClusterManager";
	}
	interface Env {
		ASSETS: Fetcher;
		RAFT_NODE: DurableObjectNamespace<import("./src/index").RaftNode>;
		CLUSTER_MANAGER: DurableObjectNamespace<import("./src/index").ClusterManager>;
	}
}
